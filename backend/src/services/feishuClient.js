...
const defaultFieldAliases = {
  ...
  grade: ['年级', '年级（选择）', '年级(选择)', '学段', '年级段', '年级级别'],
  week: ['周', '周（选择）', '周(选择)', '周次', '课时', '教学周', '周课'],
  type: ['所属类型', '类型', '所属类型（选择）', '所属类型(选择)', '工单类型', '问题类型', '类别', '分类', '所属类别', '工单分类'],
  description: ['问题描述', '描述', '问题', '工单描述', '问题详情', '问题详述', '问题描述（必填）', '问题描述(必填)', '详情', '内容', '工单内容', '问题内容'],
  status: ['状态', '状态（选择）', '状态(选择)', '工单状态', '处理状态', '当前状态', '进度'],
  reporter: ['上报人', '提交人', '提报人', '发起人', '创建人', '上报人员'],
